...
Тестовое задание на реализацию микросервисной архитектуры с использованием .NET 8, PostgreSQL, Clean Architecture и CQRS.
...
- **TrueCodeTest.Shared.Domain** - Общие сущности и DbContext
...
- **Тесты** используют InMemory базу данных и покрывают основные сценарии команд и запросов
- **Валидация** входных данных реализована на уровне хендлеров CQRS
